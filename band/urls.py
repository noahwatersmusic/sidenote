...
urlpatterns = [
    ...
    path('services/<str:plan_id>/songs/add/', views.service_song_add, name='service_song_add'),
    path('services/<str:plan_id>/songs/<int:ss_id>/remove/', views.service_song_remove, name='service_song_remove'),
